...
- `vineyard_dusk.jpg` — "A vineyard with a sunset" by Beatrice Zinetti,
  via Unsplash (https://unsplash.com/photos/a-vineyard-with-a-sunset-7Bk2QKqwQRY).
  Unsplash License: free for commercial use, no attribution required
  (attribution given anyway). Downscaled/recompressed for app bundling.
